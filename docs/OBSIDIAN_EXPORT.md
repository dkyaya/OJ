...
OJ can download one trade idea, one catalyst, or a complete ZIP of Markdown files. The full export contains a README, Dashboard, Trade Ideas, Catalysts, Trades, Journal, and Research indexes. Filenames are sanitized and unknown values stay `TBD`.
