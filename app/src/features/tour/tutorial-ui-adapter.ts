...
export function tutorialUiWorkspace(workspace: TutorialWorkspace, options: { previewIdea?: boolean; previewCandidate?: boolean } = {}): Workspace {
  ...
  return {
    ...
    researchSources: [], researchSnapshots: workspace.tutorialResearchSnapshotSaved ? [snapshotView(workspace, catalyst)] : [], removedResearchSnapshots: [], positions: position ? [position] : [], journal, opportunities: [],
