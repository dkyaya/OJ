...
- permits private Ideas/Trades to preserve direct provenance to another member’s workspace-visible Catalyst after validating active access at assignment and entry;
...
- introduces additive RLS-safe migration/RPC protection and synthetic three-user workspace/privacy SQL checks;
...
3. Run the structural and rolled-back synthetic three-user SQL tests in a trusted test session.
