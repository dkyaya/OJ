...
- SQL structural and synthetic two-user files were authored and statically reviewed but not executed. The environment has no Supabase CLI, Postgres, Docker, or development branch, and production was not used for destructive test fixtures.
